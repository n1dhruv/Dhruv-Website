      ...
      {experiences.map((exp, index) => (
        ...
        >
          ...
          <div className="flex flex-col gap-3 flex-1 min-w-0">
            ...
            {/* Role + company */}
            <div>
              <h3 className="font-display font-bold text-snow text-base sm:text-lg leading-snug tracking-tight">
                {exp.role}
              </h3>
            ...
            {/* Description */}
            <ul className="text-snow/80 text-sm leading-relaxed space-y-1.5 mt-1">
