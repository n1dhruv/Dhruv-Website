...
const MusicSkeleton = () => {
  return (
    <section id="audio-status" className="w-full" aria-hidden="true">
      <div className="panel p-4 sm:p-5 w-full flex flex-col gap-3 select-none">
        {/* Top row skeleton */}
...
const MusicStatus = () => {
  ...
  return (
    <section id="audio-status" className="w-full">
      <motion.div
